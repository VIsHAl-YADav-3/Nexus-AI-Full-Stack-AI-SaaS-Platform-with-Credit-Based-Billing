...
const Signup = () => {
  ...
  return (
    <div className="min-h-screen bg-base-950 flex items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="pointer-events-none absolute -top-40 -right-40 w-96 h-96 bg-accent-violet/20 rounded-full blur-[120px]" />
      <div className="pointer-events-none absolute -bottom-40 -left-40 w-96 h-96 bg-accent-indigo/20 rounded-full blur-[120px]" />
      ...
      <div className="relative w-full max-w-md">
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-sm text-zinc-500 mt-1">Get 50 free credits when you sign up</p>
        </div>
